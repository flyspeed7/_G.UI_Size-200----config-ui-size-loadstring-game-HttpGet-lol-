...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(240, 151, 151),
			Second = Color3.fromRGB(240, 151, 151),
			Stroke = Color3.fromRGB(13, 0, 143),
			Divider = Color3.fromRGB(13, 0, 143),
			Text = Color3.fromRGB(80, 80, 80),
			TextDark = Color3.fromRGB(13, 0, 143)
		}
	},
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local CloseBtn = SetChildren(SetProps(MakeElement("Button"), {
		...
		AddThemeObject(SetProps(MakeElement("Image", "rbxassetid://7733997941"), {
